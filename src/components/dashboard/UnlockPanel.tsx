      ...
      <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Mục này được bảo vệ bằng mật khẩu do quản trị viên đặt. Nhập mật khẩu để mở khóa
            reaction role, giveaway, gửi DM trực tiếp và auto reply.
          </p>
        </div>
        ...
        <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
          ...
          Quên mật khẩu? Vào Cài đặt để đặt lại (cần quyền quản lý server).
        </p>
      </CardContent>
    </Card>
  );
